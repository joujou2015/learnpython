...
def main():
    emps = [
        Manager('Liu'), Programmer('zhuge'),
        Manager('Cao'), Salesman('Xun'),
        Salesman('Lve'), Programmer('Zhang'),
        Programmer('Zhao')
    ]
    for emp in emps:
        if isinstance(emp, Programmer):
            emp.working_hour = int(input('Please insert %s working time this month: ' % emp.name))
        elif isinstance (emp, Salesman):
            emp.sales = float(input('Please insert %s salse this month: ' % emp.name))
